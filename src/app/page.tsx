...
export default function LandingPage() {
  ...
  <div id="reviews" data-section="reviews">
      ...
      testimonials={[
        ...
        {
          id: "3",          title: "Top Quality",          quote: "I've been looking for a consistent barber, and this is the place.",          name: "David Dvořák",          role: "IT Consultant",          imageSrc: "http://img.b2bpic.net/free-photo/front-view-young-male-grey-t-shirt-shaving-his-head-with-electric-razor-ice-blue_140725-33379.jpg"},
        {
  ...
  <div id="about" data-section="about">
      ...
      metrics={[
        {
          icon: Scissors,
          label: "Haircuts Per Week",          value: "200+"},
        {
          icon: Clock,
  ...
  <div id="socialProof" data-section="socialProof">
      ...
      names={[
        "Prague Lifestyle",        "City Grooming Daily",        "Czech Gentleman Weekly",        "Urban Barber Collective",        "Modern Man Society"]}
    />
  </div>
